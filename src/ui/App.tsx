...
export function App() {
  ...
  const [openSystemTab, setOpenSystemTab] = useState<IslandTab>('island');
   ...
   * With no filter it opens on the island's own tab, as it always did, and the tabs
