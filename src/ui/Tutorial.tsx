...
const STEPS: Array<{ title: string; body: (side: PlayableFaction) => string }> = [
  {
    ...
    body: (side) => {
      ...
      return `A war for the Seven Seas: sixty-nine islands in eight chains. You are the ${you.name}. ${them.name} is out there with ships, officers and islands of its own, and it wants what you have.`;
    },
  },
  {
    title: 'How you win',
