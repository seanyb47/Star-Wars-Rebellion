...
const STEPS: Array<{ title: string; body: (side: PlayableFaction) => string }> = [
  ...
  },
  {
    title: 'The chart',
    body: () =>
      'Every island is a dot in the colour of who holds it: green the Crown, red the Confederacy, blue nobody yet, grey not charted. A ring marks a capital. Tap a chain of islands to zoom in.',
  },
  {
    title: 'One island',
    body: () =>
