...
Every clip: 5 seconds, from the still named, using the prompt given, word for word. Every prompt ends with "camera completely static, no zoom, no pan" — never drop it; the clips must loop, and any camera drift ruins that.
