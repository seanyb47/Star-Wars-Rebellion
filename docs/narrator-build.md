...
| C1–C6 twelve clips | HUMAN | **optional** (1/12 made) | Rebellion-style gesture animation now covers talking and mood in code; a clip, where one exists, plays over the still in the sheet. Make more only if the credits are worth it: neutral idles first |
