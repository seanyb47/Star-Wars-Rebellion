...
THE THREE EXPRESSIONS. Neutral: as described. Grave — Crane: even stiller, eyes fractionally wider, mouth a straight line, nothing else moves; Pennywhistle: hunched and low, head down, feathers flat, good eye narrowed. Encouraged — Crane: the faintest tilt of the head, the barest suggestion of approval, almost indistinguishable from neutral; Pennywhistle: upright and bright, chest out, head cocked high, beak slightly open mid-squawk, feathers lifted.

RULES. The first approved Crane neutral is the style anchor; every later image matches its brushwork, palette, lighting and framing exactly. When changing an expression, change only the face: pose, clothing, plumage, background and lighting stay identical. Crane never blinks and never smiles; his three faces differ by millimetres. The signature details survive every variant: Crane's white coral on the collar-wing and brass chain to the ledger; Pennywhistle's stitched leather patch with the bone button and the three links of snapped chain on his leg.

FILE NAMES, fixed, PNG, vertical 4:5, largest size available: crane_neutral.png, crane_grave.png, crane_encouraged.png, pennywhistle_neutral.png, pennywhistle_grave.png, pennywhistle_encouraged.png.
